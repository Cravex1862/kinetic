...
import {
  BrowserFrame,
  HeroMetricCard,
} from "@/renderer/primitives/StructuralSDK";
                ...
                <div className="p-6 space-y-5 text-white bg-gray-950/85 backdrop-blur-md rounded-b-xl border-t border-gray-800 h-[calc(100%-36px)] flex flex-col justify-between overflow-y-auto">
                  <div className="flex items-center justify-between border-b border-gray-800/80 pb-3">
                    ...
                    <div className="flex gap-2.5">
                      ...
                      <button
                        style={{
                          borderColor: swatches["Accent"] || "#f59e0b",
                          color: swatches["Accent"] || "#f59e0b",
                        }}
                  ...
                  <div className="space-y-1.5">
                    <h3
                      style={{
                        ...
                        fontStyle: fonts["Heading"]?.italic
                          ? "italic"
                          : "normal",
                        textDecoration: fonts["Heading"]?.underline
                          ? "underline"
                          : "none",
                      }}
                    ...
                    >
                      Selected fonts, color swatches, and background wallpapers
                      cascade live across all video scenes and components.
                    </p>
                  </div>
                      ...
                      <BarChart
                        data={[
                          ...
                          },
                          {
                            label: "Feb",
                            value: 65,
                            color: swatches["Secondary"] || "#3b82f6",
                          },
                          {
                            label: "Mar",
                            value: 85,
