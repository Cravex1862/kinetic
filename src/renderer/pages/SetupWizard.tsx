                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['openai', 'anthropic', 'google', 'groq', 'hackclub', 'ollama', 'lmstudio', 'byoc'].map((key) => (
                      ...
                      >
                        {key === 'openai' && (
                          <>
                            <OpenAiLogo size={16} className="text-white flex-shrink-0" />
                            <span>OpenAI</span>
                          </>
                        )}
                        {key === 'anthropic' && (
                          <>
                            <span className="font-extrabold text-amber-500 tracking-tighter text-xs select-none mr-0.5 leading-none flex-shrink-0">A\</span>
                            <span>Anthropic</span>
                          </>
                        )}
                        {key === 'google' && (
                        ...
                        {key === 'groq' && (
                          <>
                            <Lightning size={16} className="text-orange-400 flex-shrink-0" />
                            <span>Groq</span>
                          </>
                        )}
                        {key === 'hackclub' && (
                          <>
                            <div className="h-3.5 w-3.5 rounded-full bg-orange-600 flex items-center justify-center text-[9px] font-extrabold text-white font-sans select-none leading-none flex-shrink-0">
                              h
                            </div>
                            <span>Hack Club</span>
                          </>
